...
namespace WebApplication1.Controllers
{
    public class ClassesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StudentId,Name,Surrname,Group")] Class @class)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentId,Name,Surrname,Group")] Class @class)
        {
